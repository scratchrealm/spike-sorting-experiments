...
# Compare sorting outputs of k3 with ms5
...
def main():
    ...
    # kilosort3
    sorting2 = load_sorting(project, 'generated/000409/sub-CSH-ZAD-001/sub-CSH-ZAD-001_ses-3e7ae7c0-fe8b-487c-9354-036236fa1010_behavior+ecephys+image_desc-kilosort3-10min.nwb')
