...
# Compare the sorting output of two runs of ks3 - one 10min and one 20min
...
def main():
    ...
    # kilosort3 - 10min
    sorting1 = load_sorting(project, 'generated/000409/sub-CSH-ZAD-001/sub-CSH-ZAD-001_ses-3e7ae7c0-fe8b-487c-9354-036236fa1010_behavior+ecephys+image_desc-kilosort3-10min.nwb')

    # kilosort3 - 20min
    sorting2 = load_sorting(project, 'generated/000409/sub-CSH-ZAD-001/sub-CSH-ZAD-001_ses-3e7ae7c0-fe8b-487c-9354-036236fa1010_behavior+ecephys+image_desc-kilosort3-20min.nwb')
    ...
    for ii1, unit_id_1 in enumerate(unit_ids_1):
        ...
        for ii2, unit_id_2 in enumerate(unit_ids_2):
            ...
            st2 = st2[st2 < 10 * 60 * sorting2.get_sampling_frequency()] # only compare first 10 minutes
